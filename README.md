...
M.Sc. researcher at the **University of Stuttgart** working on **controllable generative models** — building models whose outputs you can precisely steer through dense, structured conditioning. My research spans **video diffusion** and **latent representation design** for **autonomous-driving simulation**, and **neural audio codecs and controllable text-to-speech**, where I trained generative speech models as a researcher at **Sony Europe**.

🌐 More on my portfolio → **[jaseel.live](https://jaseel.live)**

## 🏆 Recent Highlights

- 🥇 **1st place** — Energy Hack Munich (ENERPARC × Invertix) · *Jun 2026*
- 🥈 **2nd place** — Algorand x402 Hackathon (Berlin) · *Jun 2026*
- 🥈 **2nd place** — Ignition AI Hackathon (EPFL × UNIL) · *May 2026*
...
- **Neural Codec Text-to-Speech with Controllable Duration & Voice Cloning** · *Research at Sony Europe, AI Speech & Sound Group*
  Trained autoregressive Transformer models for neural-codec TTS on multi-GPU infrastructure, with speaker-rate prefix conditioning for controllable speech tempo and reference-audio voice cloning.

## 🛠️ Stack

`PyTorch` · `HuggingFace Diffusers & Transformers` · `Diffusion / VAE / ControlNet` · `multi-GPU SLURM` · `Python` · `C/C++`
